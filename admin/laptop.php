...
<section class="add-products">
    <h1 class="heading">Add Laptops</h1>
    <form action="" method="post" enctype="multipart/form-data">
        <div class="flex">
            <div class="inputBox">
                <span>Laptop name (required)</span>
                <input type="text" class="box" required maxlength="100" placeholder="Enter laptop name" name="name">
            </div>
            <div class="inputBox">
                <span>Laptop price (required)</span>
                <input type="number" min="0" class="box" required max="9999999999" placeholder="Enter laptop price" onkeypress="if(this.value.length == 10) return false;" name="price">
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
                <span>Laptop details (required)</span>
                <textarea name="details" placeholder="Enter Laptop details" class="box" required maxlength="500" cols="30" rows="10"></textarea>
            </div>
        </div>

        <input type="submit" value="Add Laptop" class="btn" name="add_car" style="width: 60%; position:relative;left: 110px; ">
    </form>
</section>
<div class="any1">
<div class="any">
...
<!--                    <img src="/--><?php //= $cart_row['img']; ?><!--" style="width: 332.96px;height: 233.9px;" alt="">-->
                    <img src="/uploaded_img/<?= $cart_row['img']; ?>" alt="Car Image" style="width: 350px;height: 300px">
