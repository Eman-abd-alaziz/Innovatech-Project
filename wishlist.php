...
<section class="products">
   ...
   <form action="" method="post" class="box">
      ...
      <input type="hidden" name="image" value="./uploaded_img/<?= $fetch_wishlist['image']; ?>">
      <a href="quick_view.php?pid=<?= $fetch_wishlist['pid']; ?>" class="fas fa-eye"></a>
       <img src="./uploaded_img/<?= $fetch_wishlist['image']; ?>"  style="width: 332.96px;height: 300px;" alt="">

<!--       <img src="./uploaded_img/--><?php //= $fetch_wishlist['image']; ?><!--" alt="">-->
